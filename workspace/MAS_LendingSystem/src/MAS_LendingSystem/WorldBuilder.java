...
public class WorldBuilder implements ContextBuilder<Object> {	
	...
	public Context<Object> build(Context<Object> context) {
		...
		final double neighborhoodInfluence = 0.5;
		final boolean neighborhoodInfluenceClustered = false;
		final boolean desireClustered = false;
...
//					for (Cell gc: adj.) {
	...
	public double getNormalDist(double min, double max, double mean) {
		...
		double sd = (max - min) / 6;
		Normal n = RandomHelper.createNormal(trueMean, sd);
